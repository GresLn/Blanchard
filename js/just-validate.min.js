...
! function (e, i) {
  ...
  return class {
    constructor(e, i, s) {
      __publicField(this, "form", null), __publicField(this, "fields", {}), __publicField(this, "groupFields", {}), __publicField(this, "errors", {}), __publicField(this, "isValid", !1), __publicField(this, "isSubmitted", !1), __publicField(this, "globalConfig", n), __publicField(this, "errorLabels", {}), __publicField(this, "successLabels", {}), __publicField(this, "eventListeners", []), __publicField(this, "dictLocale", []), __publicField(this, "currentLocale"), __publicField(this, "customStyleTags", {}), __publicField(this, "onSuccessCallback"), __publicField(this, "onFailCallback"), __publicField(this, "tooltips", []), __publicField(this, "lastScrollPosition"), __publicField(this, "isScrollTick"), __publicField(this, "refreshAllTooltips", (() => {
    ...
    validateGroupRule(e, i, s, t) {
      if (t.rule === r.Required) "radio" !== i && "checkbox" !== i || (s.every((e => !e.checked)) ? this.setGroupInvalid(e, t) : this.setGroupValid(e, t))
    }
      ...
      if (n.plugin) {
        ...
        switch (n.rule) {
          ...
          case l.MaxLength:
            ...
            if ("" === u) break;
            ((e, i) => e.length > i)(u, c) && this.setFieldInvalid(r, n);
            break;
          case l.MinLength:
            if (void 0 === c) {
              console.error(`Value for ${n.rule} rule for [${r}] field is not defined. The field will be always invalid.`), this.setFieldInvalid(r, n);
          ...
          case l.Password:
            ...
            if ("" === u) break;
            (e => s.test(e))(u) || this.setFieldInvalid(r, n);
            break;
          case l.StrongPassword:
            if ("string" != typeof u) {
              this.setFieldInvalid(r, n);
            ...
            if ("" === u) break;
            (e => t.test(e))(u) || this.setFieldInvalid(r, n);
            break;
          case l.Number:
            if ("string" != typeof u) {
              this.setFieldInvalid(r, n);
            ...
            if ("" === u) break;
            (e => i.test(e))(u) || this.setFieldInvalid(r, n);
            break;
          case l.MaxNumber: {
            if (void 0 === c) {
              console.error(`Value for ${n.rule} rule for [${r}] field is not defined. The field will be always invalid.`), this.setFieldInvalid(r, n);
            ...
            if ("" === u) break;
            const e = +u;
            (Number.isNaN(e) || ((e, i) => e > i)(e, c)) && this.setFieldInvalid(r, n);
            break
          }
          case l.MinNumber: {
            if (void 0 === c) {
          ...
          case l.CustomRegexp: {
            if (void 0 === c) return console.error(`Value for ${n.rule} rule for [${r}] field is not defined. This field will be always invalid.`), void this.setFieldInvalid(r, n);
            let e;
            try {
              e = new RegExp(c)
            } catch (f) {
          ...
          case l.Files: {
            if (void 0 === c) return console.error(`Value for ${n.rule} rule for [${r}] field is not defined. This field will be always invalid.`), void this.setFieldInvalid(r, n);
            if ("object" != typeof c) return console.error(`Value for ${n.rule} rule for [${r}] field should be an object. This field will be always invalid.`), void this.setFieldInvalid(r, n);
            const e = c.files;
          ...
          default: {
            ...
            const e = n.validator(u, this.fields);
    ...
    validateGroup(e, i) {
      ...
      return [...i.rules].reverse().forEach((t => {
        const l = this.validateGroupRule(e, i.type, i.elems, t);
        a(l) && s.push(l)
    ...
    addRequiredGroup(e, i, s, t) {
      ...
      const o = l.querySelectorAll("input"),
        a = Array.from(o).every((e => "radio" === e.type)),
        n = Array.from(o).every((e => "checkbox" === e.type));
    ...
    clearErrors() {
      ...
      for (const s in this.groupFields) {
        ...
        Object.keys(l).forEach((e => {
          t.elems.forEach((i => {
            var s;
            i.style[e] = "", i.classList.remove((null == (s = t.config) ? void 0 : s.errorFieldCssClass) || this.globalConfig.errorFieldCssClass)
          }))
        }));
        ...
        Object.keys(r).forEach((e => {
          t.elems.forEach((i => {
            var s;
            i.style[e] = "", i.classList.remove((null == (s = t.config) ? void 0 : s.successFieldCssClass) || this.globalConfig.successFieldCssClass)
          }))
        }))
      }
      this.tooltips = []
    ...
    createErrorLabelElem(e, i, s) {
      ...
      return Object.assign(t.style, l), t.classList.add((null == s ? void 0 : s.errorLabelCssClass) || this.globalConfig.errorLabelCssClass, "just-validate-error-label"), this.isTooltip() && (t.dataset.tooltip = "true"), this.globalConfig.testingMode && (t.dataset.testId = `error-label-${e}`), this.errorLabels[e] = t, t
    }
    createSuccessLabelElem(e, i, s) {
      ...
      return Object.assign(t.style, l), t.classList.add((null == s ? void 0 : s.successLabelCssClass) || this.globalConfig.successLabelCssClass, "just-validate-success-label"), this.globalConfig.testingMode && (t.dataset.testId = `success-label-${e}`), this.successLabels[e] = t, t
    }
    ...
    renderFieldError(e) {
      ...
      if (a.isValid) {
        if (!a.asyncCheckPending) {
          const t = this.createSuccessLabelElem(e, a.successMessage, a.config);
          t && this.renderFieldLabel(a.elem, t, null == (i = a.config) ? void 0 : i.errorsContainer, !0), a.elem.classList.add((null == (s = a.config) ? void 0 : s.successFieldCssClass) || this.globalConfig.successFieldCssClass)
        }
        return
      }
